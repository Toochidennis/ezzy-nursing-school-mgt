    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    <a href="createSession.php" aria-haspopup="true"
                        aria-expanded="false"> <i class="menu-icon fa fa-cogs"></i>Sessions</a>
                    <!-- <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-plus"></i> <a href="createSession.php?action=create_session">Add New Session</a></li>
                    </ul> -->
                </li>
                ...
                <li class="menu-item-has-children dropdown <?php if ($page == 'student') {
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        ...
                        <li><i class="fa fa-eye"></i> <a href="viewStudents.php">View Student</a></li>
                    </ul>
                </li>
                <li class="menu-item-has-children dropdown <?php if ($page == 'courses') {
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-plus"></i> <a href="createCourse.php">Create Course</a></li>
                        <li><i class="fa fa-eye"></i> <a href="studentsSelection.php">Course Registration</a></li>
                    </ul>
                </li>
