...
<body>
    ...
    <div id="right-panel" class="right-panel">
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Student selection</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-header">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        <label for="levelSelect">Filter by Level:</label>
                            ...
                            <div class="card-body">
                                <table
                                    ...
                                    <thead>
                                        <tr>
                                            <th data-field="state">
                                                <input class="text-center" type="checkbox" id="selectAll" onchange="toggleSelectAll(this)">
                                            </th>
                                            <th data-field="index">S/N</th>
                                            <th data-field="matricNumber">Matric number</th>
                                            <th data-field="fullname">Fullname</th>
                                            <th data-field="noOfCourses">No. of courses</th>
        ...
        <button id="registerButton" class="fab btn btn-primary tooltip-btn"
            ...
            <span class="tooltip-text">Register Selected Students</span>
        </button>
    ...
    <script src="../js/api/v1/student-selection.js"></script>
